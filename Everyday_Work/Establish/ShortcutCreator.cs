...
namespace Everyday_Work.Establish
{
    ...
    internal class ShortcutCreator
    {
        ...
        /// <remarks></remarks>
        private static void CreateShortcut(string directory, string shortcutName, string targetPath,string description = null, string iconLocation = null)
        {
            ...
            ClearShortuct(shortcutName, shortcut.FullName);
        }

        private static EstablishFiles establishFiles = EstablishFiles.CanheObject;
        /// <summary>
        /// 删除旧的日志快捷方式
        /// </summary>
        /// <param name="shortcutName"></param>
        /// <param name="targetPath"></param>
        private static void ClearShortuct(string shortcutName,string targetPath)
        {
            string last_name = ConfigurationManager.AppSettings["lastName"].ToString();

            if (!last_name.Equals(shortcutName))
            {
                System.IO.File.Delete(targetPath);
                establishFiles.SetValue("lastName", shortcutName);
